...
```bash
git clone https://github.com/jialog0301/RVROS2.git
```

进入子文件夹根据自己的系统和运行环境进行修改。
### 3. 对dockerfile文件进行修改
>[!note]
>此时的dockerfile并不能直接进行使用，必须根据你的运行环境进行微调
>
...
```
![PixPin_2025-12-01_15-21-03.png|650](https://weijiale.oss-cn-shanghai.aliyuncs.com/picgo/20251201152118351.png)
...
我采用的方法是将板子和我的电脑连到**同一个局域网**下然后通过SSH进行开发。此方法相较于有线连接各有优劣，不过采用ssh同样能够完成开发需求。
![PixPin_2025-11-06_12-47-51.png|650](https://weijiale.oss-cn-shanghai.aliyuncs.com/picgo/20251106124755652.png)
然后通过SSH软件将tar包传输到开发板
